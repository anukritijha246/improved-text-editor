...
public class MyEditor {
	...
	private void createAndShowGUI() {
		...
		DictionaryActionListener dictionaryActionListener=new DictionaryActionListener();
        JButton dicButton=new JButton();
        dicButton.setText("Search Meaning");
		dicButton.addActionListener(dictionaryActionListener);
	...
	private class DictionaryActionListener implements ActionListener {

		@Override
		public void actionPerformed(ActionEvent e) {
			String str=editor__.getSelectedText();
			JSONParser jsonParser = new JSONParser();
	         
	        try (FileReader reader = new FileReader("C:\\Users\\ANUKRITI JHA\\Desktop\\Python\\word predicting dictionary\\dictionary.json"))
	        {
	            //Read JSON file
	            Object obj = jsonParser.parse(reader);
	        // typecasting obj to JSONObject 
	        JSONObject jo = (JSONObject) obj; 
	      //  String meaning= (String) jo.get(str); 
	        JSONArray ja=(JSONArray) jo.get(str);
	        Dialog d;  
	        Frame f= new Frame();  
	        d = new Dialog(f , "Meaning of "+str, true);
